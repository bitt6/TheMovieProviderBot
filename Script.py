...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs @Acctual_thing</b>"""
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ ɴᴀᴍᴇ: <code>{file_name}</code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Actual Thing](https://t.me/+kAh07hUHdt9mZjFl)</b>"""
